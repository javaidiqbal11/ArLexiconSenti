...
rf_classifier = DecisionTreeClassifier(max_depth=100, max_leaf_nodes=500, criterion="gini")
...
df["y_pred"] = y_pred
df["y_true"] = y_test
df["binary_decision_tree_sentiment"] = y_pred
df.to_csv("data/binary_decision_tree_sentiment.csv", index=False)
